...
Description, taken from the assignment spec[http://web.cs.ucla.edu/classes/winter17/cs111/assign/lab1.html]
File Flags, which correspond to the oflag value for open[http://pubs.opengroup.org/onlinepubs/9699919799/functions/open.html]:
--append
	O_APPEND
--cloexec
	O_CLOEXEC
